...
{
#if KK_PLATFORM_IOS
	return [[CCDirector sharedDirector].openGLView isUserInteractionEnabled];
#else
	return NO;
#endif
}
...
{
#if KK_PLATFORM_IOS
	[[CCDirector sharedDirector].openGLView setUserInteractionEnabled:enabled];
#endif
}
...
{
#if KK_PLATFORM_IOS
	return [CCDirector sharedDirector].openGLView.multipleTouchEnabled;
#else
	return NO;
#endif
}
...
{
#if KK_PLATFORM_IOS
	[CCDirector sharedDirector].openGLView.multipleTouchEnabled = enabled;
#endif
}
