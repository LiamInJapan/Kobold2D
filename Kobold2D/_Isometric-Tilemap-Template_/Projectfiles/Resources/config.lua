...
local config =
{
	KKStartupConfig = 
	{
		...
		GLViewDepthFormat = GLViewDepthFormat.Depth24Bit,	-- Depth buffer required for correct Z ordering of Iso tiles
		GLViewMultiSampling = NO,
		GLViewNumberOfSamples = 0,

		Enable2DProjection = YES,							-- 2D projection required for correct Z ordering of Iso tiles
		...
		WindowFrame = RectMake(1024-640, 768-480, 960, 700),
		EnableFullScreen = NO,
	},
