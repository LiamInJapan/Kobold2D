...
-(void) addLabels
{
	...
	CCLabelTTF* label1 = [CCLabelTTF labelWithString:@"Move ship by tilting device" fontName:@"Arial" fontSize:22];
	label1.position = CGPointMake(screenCenter.x, screenCenter.y + 140);
	label1.color = ccYELLOW;
	[self addChild:label1];

	CCLabelTTF* label2 = [CCLabelTTF labelWithString:@"Using RAW accelerometer values" fontName:@"Arial" fontSize:22];
