...
local config =
{
	...
	SpriteBatchSettings =
	{
		-- initial number of sprites displayed on screen
		NumberOfSpritesToStartWith = 10,
		-- for every touch or mouse click the number of sprites is multiplied by this number
		IncreaseNumberOfSpritesByFactor = 2.0,
		-- how often the user can touch to increase/decrease sprites before switching to the next mode
		IncreaseNumberOfSpritesThisManyTimes = 10,
	},
}
