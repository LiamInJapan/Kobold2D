...
local config =
{
	KKStartupConfig = 
	{
		...
		GLViewColorFormat = GLViewColorFormat.RGBA8888,			-- recommended for Cocos3D
		GLViewDepthFormat = GLViewDepthFormat.Depth16Bit,		-- required for Cocos3D
		...
		AutorotationType = Autorotation.None,					-- Cocos3D NodeController handles autorotation
